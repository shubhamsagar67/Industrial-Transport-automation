...
class ComplainDAO:
    ...
    def admin_view_complain(self):  # admin side view the all complain
        complain_vo_list = db.session.query(ComplainVO, LoginVO) \
            .join(LoginVO,
                  ComplainVO.complain_from_login_id == LoginVO.login_id) \
            .all()
        return complain_vo_list
    ...
    def edit_complain(self,
                      complain_vo):  # admin give the reply of complain ,fetch the complain data
    ...
    def agency_view_user_complain(self):
        complain_vo_list = db.session.query(ComplainVO, LoginVO) \
            .join(LoginVO,
                  ComplainVO.complain_from_login_id == LoginVO.login_id) \
            .filter_by(login_role="user") \
            .all()
        return complain_vo_list
