...
class LoginDAO:
    ...
    def find_login_id(self, login_vo):
        login_vo_list = LoginVO.query.filter_by(
            login_username=login_vo.login_username).first()
        login_id = login_vo_list.login_id
        return login_id

    def find_login_agencyname(self, login_vo):
        login_vo_list = LoginVO.query.filter_by(
            login_id=login_vo.login_id).all()
        login_agencyname = login_vo_list[0].login_agencyname
        return login_agencyname
